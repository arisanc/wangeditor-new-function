...
var _bind = _interopRequireDefault(__webpack_require__(87));

var _includes = _interopRequireDefault(__webpack_require__(113));

var _filter = _interopRequireDefault(__webpack_require__(88));

var _splice = _interopRequireDefault(__webpack_require__(89));
...
var _setTimeout2 = _interopRequireDefault(__webpack_require__(66));
...
exports.addCss = exports.hexToRgb = exports.getRandomCode = exports.toArray = exports.deepClone = exports.isFunction = exports.debounce = exports.throttle = exports.arrForEach = exports.forEach = exports.replaceSpecialSymbol = exports.replaceHtmlSymbol = exports.getRandom = exports.UA = void 0;
...
function addCss(css) {
  if (document) {
    ...
    style.innerHTML = css;
    var parentElemnt = document.getElementsByTagName('HEAD').item(0);

    if (parentElemnt) {
      parentElemnt.appendChild(style);
    } else {
      console.error('不存在HEAD');
    }
...
var Menu_1 = __importDefault(__webpack_require__(94));

var DropList_1 = __importDefault(__webpack_require__(126));
...
var DOMIterables = __webpack_require__(178);
var global = __webpack_require__(8);
...
var global = __webpack_require__(8);
var setGlobal = __webpack_require__(141);
...
var createIteratorConstructor = __webpack_require__(176);
...
exports.TableHotKey = void 0;

var dom_core_1 = __importDefault(__webpack_require__(2));

var getNode_1 = __importDefault(__webpack_require__(129));

var operating_event_1 = __importDefault(__webpack_require__(128));

var TableHotKey =
/** @class */
function () {
  function TableHotKey(editor) {
    var _this = this;

    this.getnode = new getNode_1["default"](editor);

    this.addLine = function (editor, $node) {
      // 禁止多选操作
      ...
      var $currentRow = _this.getnode.getRowNode(selectDom.elems[0]);
      ...
      var index = Number(_this.getnode.getCurrentRowIndex($node, $currentRow)); //生成要替换的html

      var htmlStr = _this.getnode.getTableHtml($node); //生成新的table


      var newdom = _this.getnode.getTableHtml(operating_event_1["default"].ProcessingRow(dom_core_1["default"](htmlStr), index).elems[0]); // 选中table


      editor.selection.createRangeByElem(dom_core_1["default"]($node));
      editor.selection.restoreSelection();
      editor.cmd["do"]('insertHTML', newdom);
      return true;
    };

    this.delTable = function (editor, $node) {
      // 选中img元素
      editor.selection.createRangeByElem(dom_core_1["default"]($node));
      editor.selection.restoreSelection();
    ...
    this.delLine = function (editor, $node) {
      // 禁止多选操作
      var isMore = isMoreRowAction(editor);
      ...
      var htmlStr = _this.getnode.getTableHtml($node); //获取新生成的table 判断是否是最后一行被删除 是 删除整个table
      ...
      if (trLength === 0) {
        ...
        newdom = _this.getnode.getTableHtml(operating_event_1["default"].DeleteRow(dom_core_1["default"](htmlStr), index).elems[0]);
      }
    ...
    this.delColumn = function (editor, $node) {
      // 禁止多选操作
      var isMore = isMoreRowAction(editor);
      ...
      var index = _this.getnode.getCurrentColIndex(selectDom.elems[0]); //生成要替换的html


      var htmlStr = _this.getnode.getTableHtml($node); //获取新生成的table 判断是否是最后一列被删除 是 删除整个table
      ...
      if (tdLength === 1) {
        ...
        newdom = _this.getnode.getTableHtml(operating_event_1["default"].DeleteCol(dom_core_1["default"](htmlStr), index).elems[0]);
      }
    ...
    this.addTableHead = function (editor, $node) {
      // 禁止多选操作
      var isMore = isMoreRowAction(editor);
      ...
      var index = Number(_this.getnode.getCurrentRowIndex($node, $currentRow));
      ...
      var newdom = _this.getnode.getTableHtml(operating_event_1["default"].setTheHeader(dom_core_1["default"](htmlStr), index, 'th').elems[0]); // 选中table
      ...
      editor.cmd["do"]('insertHTML', newdom);
      return true;
    }, this.delTableHead = function (editor, $node) {
      //当前元素
      var selectDom = dom_core_1["default"](editor.selection.getSelectionStartElem()); //当前行
      ...
      var newdom = _this.getnode.getTableHtml(operating_event_1["default"].setTheHeader(dom_core_1["default"](htmlStr), index, 'td').elems[0]); // 选中table
    ...
    this.addColumn = function (editor, $node) {
      // 禁止多选操作
      var isMore = isMoreRowAction(editor);
      ...
      var newdom = _this.getnode.getTableHtml(operating_event_1["default"].ProcessingCol(dom_core_1["default"](htmlStr), index).elems[0]); // 选中table
...
exports.TableHotKey = TableHotKey;
...
var stack_1 = __webpack_require__(391);
...
var defineProperty = __webpack_require__(17).f;
var uid = __webpack_require__(60);
var FREEZING = __webpack_require__(214);
...
var parse_html_1 = __importDefault(__webpack_require__(295));
/**
 * 获取粘贴的纯文本
 * @param e Event 参数
 */
...
var code_1 = __importDefault(__webpack_require__(371));

var index_21 = __importDefault(__webpack_require__(375));

var table_1 = __webpack_require__(96);
...
exports["default"] = {
  ...
  tableHotKey: table_1.TableHotKey
};
...
var index_1 = __importDefault(__webpack_require__(179));

__exportStar(__webpack_require__(410), exports); // 检验是否浏览器环境
...
var _promise = _interopRequireDefault(__webpack_require__(157));
...
var global = __webpack_require__(8);
var getBuiltIn = __webpack_require__(26);
var NativePromise = __webpack_require__(103);
var redefine = __webpack_require__(50);
var redefineAll = __webpack_require__(104);
var setToStringTag = __webpack_require__(40);
var setSpecies = __webpack_require__(105);
...
var hostReportErrors = __webpack_require__(170);
...
var config_1 = __importDefault(__webpack_require__(268));

var selection_1 = __importDefault(__webpack_require__(282));

var command_1 = __importDefault(__webpack_require__(284));

var index_1 = __importDefault(__webpack_require__(285));

var index_2 = __importDefault(__webpack_require__(304));

var init_dom_1 = __importDefault(__webpack_require__(378));

var init_selection_1 = __importDefault(__webpack_require__(379));

var bind_event_1 = __importDefault(__webpack_require__(380));

var i18next_init_1 = __importDefault(__webpack_require__(381));

var set_full_screen_1 = __importStar(__webpack_require__(131));

var scroll_to_head_1 = __importDefault(__webpack_require__(384));

var z_index_1 = __importDefault(__webpack_require__(385));

var index_3 = __importDefault(__webpack_require__(386));

var index_4 = __importDefault(__webpack_require__(388));

var disable_1 = __importDefault(__webpack_require__(403)); // 创建菜单的 class
...
var letters_1 = __webpack_require__(406);

var hotkey_1 = __importDefault(__webpack_require__(407));
...
function () {
  ...
  function Editor(toolbarSelector, textSelector) {
    this.isFullScreen = false; // 实例销毁前需要执行的钩子集合
    ...
    this.letters = new letters_1.CountLetters(this);
    this.hotkey = new hotkey_1["default"](this);
...
var arrayIncludes = __webpack_require__(192);
var stringIncludes = __webpack_require__(194);
...
var $ = __webpack_require__(4);
var notARegExp = __webpack_require__(196);
var requireObjectCoercible = __webpack_require__(46);
var correctIsRegExpLogic = __webpack_require__(198);
...
var splice = __webpack_require__(205);
...
var trim = __webpack_require__(217);
...
var forcedStringTrimMethod = __webpack_require__(219);
...
var toIndexedObject = __webpack_require__(25);
var nativeGetOwnPropertyNames = __webpack_require__(120).f;
...
var _assign = _interopRequireDefault(__webpack_require__(269));
...
var menus_1 = __importDefault(__webpack_require__(274));

var events_1 = __importDefault(__webpack_require__(275));

var style_1 = __importDefault(__webpack_require__(122));

var paste_1 = __importDefault(__webpack_require__(276));

var cmd_1 = __importDefault(__webpack_require__(277));

var image_1 = __importDefault(__webpack_require__(278));

var text_1 = __importDefault(__webpack_require__(279));

var lang_1 = __importDefault(__webpack_require__(280));

var history_1 = __importDefault(__webpack_require__(281)); // 合并所有的配置信息
...
var getChildrenJSON_1 = __importDefault(__webpack_require__(302));

var getHtmlByNodeList_1 = __importDefault(__webpack_require__(303));
...
function () {
  ...
  Text.prototype.json = function () {
    ...
    var splitCodeTageReg = /<pre><code.*?<\/code><\/pre>/g;
    var splitGroup;
    var splitGroupResult = [];
    var lastMatchIndex = 0; //拆分code标签

    while ((splitGroup = splitCodeTageReg.exec(html)) !== null) {
      var codeStart = splitGroup.index;
      var codeEnd = splitCodeTageReg.lastIndex; //推入结果

      splitGroupResult.push((0, _slice["default"])(html).call(html, lastMatchIndex, codeStart)); //推入最后

      splitGroupResult.push((0, _slice["default"])(html).call(html, codeStart, codeEnd));
      lastMatchIndex = codeEnd;
    }

    if (lastMatchIndex < html.length) {
      splitGroupResult.push((0, _slice["default"])(html).call(html, lastMatchIndex, html.length)); //插入代码后面的部分
    }

    if (splitGroupResult.length == 0) {
      splitGroupResult.push(html); //没有匹配到code标签按照常规处理
    } //转义


    for (var key in htmlCodeEscape) {
      var reg = new RegExp(key, 'g');

      for (var i = 1; i < splitGroupResult.length; i += 2) {
        splitGroupResult[i] = splitGroupResult[i].replace(reg, htmlCodeEscape[key]);
      }
    }

    for (var key in outEscape) {
      var reg = new RegExp(key, 'g');

      for (var i = 0; i < splitGroupResult.length; i += 2) {
        splitGroupResult[i] = splitGroupResult[i].replace(reg, outEscape[key]);
      }
    }

    for (var key in codeEscape) {
      var reg = new RegExp(key, 'g');

      for (var i = 0; i < splitGroupResult.length; i++) {
        splitGroupResult[i] = splitGroupResult[i].replace(reg, codeEscape[key]);
      }
    }

    var escapeResult = splitGroupResult.join('');
    return escapeResult;
  };
  /**
   * 追加 html 内容
...
var enter_to_create_p_1 = __importDefault(__webpack_require__(291));

var del_to_keep_p_1 = __importDefault(__webpack_require__(292));

var tab_to_space_1 = __importDefault(__webpack_require__(293));

var paste_text_html_1 = __importDefault(__webpack_require__(294));

var img_click_active_1 = __importDefault(__webpack_require__(301));
/**
 * 初始化 text 事件钩子函数
 * @param text text 实例
 */
...
var tags_1 = __webpack_require__(296);

var simplehtmlparser_js_1 = __importDefault(__webpack_require__(300));
/**
 * 过滤掉空 span
 * @param html html
 */
...
var menu_list_1 = __importDefault(__webpack_require__(125)); // import { MenuActive } from './menu-constructors/Menu'
...
function () {
  ...
  Menus.prototype.init = function () {
    ...
    (0, _forEach["default"])(_context = config.menus).call(_context, function (menuKey) {
      ...
      _this.menuMap[MenuConstructor.name] = m;
    }); // 渲染 DOM
...
var upload_img_1 = __importDefault(__webpack_require__(95));
...
function (_super) {
  ...
  Table.prototype.createPanel = function () {
    var conf = create_panel_conf_1["default"](this.editor);
    var panel = new Panel_1["default"](this, conf);
    panel.create(); //arisan,回车键自动插入表格,Esc退出

    var table_create_menu = panel.$container.elems[0];
    var $input = table_create_menu.getElementsByTagName('input');
    var $close = table_create_menu.getElementsByTagName('i');
    var $button = table_create_menu.getElementsByTagName('button');
    var button = {
      insert: $button[0],
      close: $close[0]
    };
...
function () {
  ...
  CreateTable.prototype.createAction = function (rowValue, colValue) {
    ...
    var tableDomString = this.createTableHtml(rowValue, colValue);
    editor.cmd["do"]('insertHTML', tableDomString);
    var ele = document.getElementById("wangeditor-table-" + this.id);

    if (ele) {
      editor.hotkey.pushElementHook(ele);
    }
  ...
  CreateTable.prototype.createTableHtml = function (rowValue, colValue) {
    ...
    var tableDom = "<table border=\"0\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" id=\"wangeditor-table-" + this.id + "\"><tbody>" + rowStr + '</tbody></table><p><br></p>';
    return tableDom;
  };
...
var create_panel_conf_1 = __importDefault(__webpack_require__(372));

var is_active_1 = __importDefault(__webpack_require__(130));

var Panel_1 = __importDefault(__webpack_require__(29));

var index_1 = __importDefault(__webpack_require__(373));
      ...
      events: [// 插入链接
      {
        ...
        fn: function fn() {
          ...
          if (is_active_1["default"](editor)) {
            ...
            //增加pre标签
            codeDom = "<pre type=\"" + languageType + "\"><code class=\"language-" + languageType + "\">" + formatCode + "</code></pre>"; // @ts-ignore
...
var tooltip_event_1 = __importDefault(__webpack_require__(374));
/**
 * 绑定事件
 * @param editor 编辑器实例
 */
...
var index_1 = __importDefault(__webpack_require__(376));
...
var tooltip_event_1 = __importDefault(__webpack_require__(377));
/**
 * 绑定事件
 * @param editor 编辑器实例
 */
...
var mutation_1 = __importDefault(__webpack_require__(387));
...
var content_1 = __importDefault(__webpack_require__(389));

var scroll_1 = __importDefault(__webpack_require__(401));

var range_1 = __importDefault(__webpack_require__(402));
/**
 * 历史记录（撤销、恢复）
 */
...
var node_1 = __importDefault(__webpack_require__(390));

var html_1 = __importDefault(__webpack_require__(399));
...
var cache_1 = __importDefault(__webpack_require__(97));

var compile_1 = __importDefault(__webpack_require__(392));

var decompilation_1 = __webpack_require__(393);
...
var _entries = _interopRequireDefault(__webpack_require__(394));
...
var $ = __webpack_require__(4);
var $entries = __webpack_require__(398).entries;
...
var chain_1 = __webpack_require__(400);
...
var englishWord = /(?<=(^|([^a-zA-Z_])))[a-zA-Z_]+(?=[^a-zA-Z_]|$)/g;
var japense = /[\u30a1-\u30f6\u3041-\u3093\uFF00-\uFFFF\u4e00-\u9fa5]/g;
/**
 * 统计字数
 * @author arisan
 */
...
/** @class */
function () {
  function CountLetters(editor) {
    this.editor = editor;
    this.init();
  }

  CountLetters.prototype.setAfterCountHook = function (func) {
    this.afterCountHook = func;
  };

  CountLetters.prototype.init = function () {
    var _this = this; //显示字数
  ...
  CountLetters.prototype.addListenerLetters = function () {
    var _this = this;
  ...
  CountLetters.prototype.countLetters = function () {
    var text = this.editor.txt.text().replace(/&nbsp;/g, '');
    var engMatch = text.match(englishWord);
    var japMatch = text.match(japense);
    var engCount = 0;
    var japCount = 0;
    ...
    if (this.fontCountElement) {
      ...
      this.fontCountElement = util_1.addCss(".w-e-text-container::after{content:'" + count + "';position: absolute;left: 90%;top: 90%;color:#999;}");
    } else {
      this.fontCountElement = util_1.addCss(".w-e-text-container::after{content:'" + count + "';position: absolute;left: 90%;top: 90%;color:#999;}");
    }
  };
...
var hotkey_1 = __importDefault(__webpack_require__(408));

var table_1 = __webpack_require__(96);

var set_full_screen_1 = __webpack_require__(131);

var HotKey =
/** @class */
function () {
  function HotKey(editor, hotkey, elementHotKey) {
    this.reg = /^(_control)?(_shift)?(_alt)?(_window)?$/;
    this.editor = editor; //this.$textContainer = editor.$textContainerElem
    //this.$bar = $('<div class="w-e-progress"></div>')

    this.elementHotKeyHook = {};
    this.HotKey = {};
    this.defaultHotKey = hotkey ? hotkey : hotkey_1["default"];
    this.elementHotKeyInstance = {
      table: new table_1.TableHotKey(editor)
    };

    this._init();
  }

  HotKey.prototype._init = function () {
    var _this = this;
  ...
  HotKey.prototype.changeScreen = function (editor) {
    console.log(editor);

    if (editor.isFullScreen) {
      set_full_screen_1.setUnFullScreen(editor);
    } else {
      set_full_screen_1.setFullScreen(editor);
    }
  }; //当创建的元素需要监听时使用


  HotKey.prototype.pushElementHook = function (element) {//没有绑定事件的一律return
  ...
  HotKey.prototype.parse_combine_key = function (e) {
    var arr = new Array(4);
    var result = '';
  ...
  HotKey.prototype.dispatchEvent = function () {
    var _a, _b, _c;

    var selectedElement = (_a = this.editor.selection.getSelectionContainerElem()) === null || _a === void 0 ? void 0 : _a.elems[0];
    var selectedStart = (_b = this.editor.selection.getSelectionStartElem()) === null || _b === void 0 ? void 0 : _b.elems[0];
    var selectedEnd = (_c = this.editor.selection.getSelectionEndElem()) === null || _c === void 0 ? void 0 : _c.elems[0];

    if (selectedEnd && selectedEnd == selectedStart) {
      //表格
      var tagName = selectedEnd.tagName.toLowerCase();
  ...
  HotKey.prototype.addEventListener = function () {
    var _this = this;

    var editor = this.editor;
    var _menu_instance = editor.menus.menuMap;
    editor.$textContainerElem.elems[0].addEventListener('keydown', function (e) {
      var _a, _b;
      ...
      var index = _this.parse_combine_key(e);

      var item = _this.HotKey[index];

      var element = _this.dispatchEvent();

      var tagName = element === null || element === void 0 ? void 0 : element.tagName.toLowerCase();
      var hasElementEvent = tagName && ((_d = (_c = _this.elementHotKeyHook[tagName]) === null || _c === void 0 ? void 0 : _c[index]) === null || _d === void 0 ? void 0 : _d[key]);
      console.log(index);

      if (hasElementEvent) {
        //调用element事件
        (_a = hasElementEvent.func).call.apply(_a, __spreadArrays([hasElementEvent.cls], [editor, element]));
        ...
        (_b = handler.func).call.apply(_b, __spreadArrays([_menu_instance[handler.cls.name]], handler.args));
    ...
    for (var tag in this.elementHotKeyHook) {
      var ele = editor.$textContainerElem.elems[0].getElementsByTagNameNS('http://www.w3.org/1999/xhtml', tag);

      if (ele.length) {
        for (var i = 0; i < ele.length; i++) {
          for (var key in this.elementHotKeyHook[tag]) {
  ...
  HotKey.prototype.setUserHotKey = function (key, code, func, type) {
  ...
  HotKey.prototype.setHotKeys = function (hotkeys) {
    for (var combineKeys in hotkeys) {
      if (!this.HotKey[combineKeys]) {
        this.HotKey[combineKeys] = {};
      }

      for (var key in hotkeys[combineKeys]) {
  ...
  HotKey.prototype.setElementHotKeys = function (elementHotKey) {
    for (var tagName in elementHotKey) {
      if (!this.elementHotKeyHook[tagName]) {
        this.elementHotKeyHook[tagName] = {};
      }

      for (var combineKey in elementHotKey[tagName]) {
        var keys = elementHotKey[tagName][combineKey];

        if (!this.elementHotKeyHook[tagName][combineKey]) {
          this.elementHotKeyHook[tagName][combineKey] = {};
        }

        for (var key in elementHotKey[tagName][combineKey]) {
          var task = elementHotKey[tagName][combineKey][key];

          if (!this.elementHotKeyHook[tagName][combineKey][key]) {
            var args = (task === null || task === void 0 ? void 0 : task.args) ? task.args : [];
  ...
  HotKey.prototype.initDefaultHotKey = function () {
    console.log('this.editor :>> ', this.elementHotKeyInstance.table.addLine);
    this.setElementHotKeys({
      table: {
        _ctrl: {
          '+': {
            func: this.elementHotKeyInstance.table.addLine,
            cls: table_1.TableHotKey
          },
          '-': {
            func: this.elementHotKeyInstance.table.delLine,
            cls: table_1.TableHotKey
          }
        }
      }
  ...
  HotKey.prototype.setEvent = function () {};

  HotKey.prototype.CreateObject = function (obj) {
    if (!obj) {
      obj = {};
    }
  };
...
exports.defaultElementHotKey = void 0;

var functions_1 = __importDefault(__webpack_require__(409));

var defaultHotKey = {
  _ctrl: {
    '1': functions_1["default"].h1,
    '2': functions_1["default"].h2,
    '3': functions_1["default"].h3,
    '4': functions_1["default"].h4,
    '5': functions_1["default"].h5,
    '6': functions_1["default"].h6,
    '0': functions_1["default"].p,
    b: functions_1["default"].bold,
    q: functions_1["default"].quote,
    i: functions_1["default"].italic,
    u: functions_1["default"].underline,
    h: functions_1["default"].highlight,
    l: functions_1["default"].link
  },
  _shift: {
    t: functions_1["default"].table
  },
  _ctrl_shift: {
    '{': functions_1["default"].li,
    '}': functions_1["default"].ul,
    '<': functions_1["default"].code,
    d: functions_1["default"].delline
  }
};
exports.defaultElementHotKey = {};
exports["default"] = defaultHotKey;
...
exports.HotKeyInstances = void 0;

var menu_list_1 = __importDefault(__webpack_require__(125));
...
/** @class */
function () {
  function HotKeyInstances(editor) {
    this.editor = editor;
    this.form = new table_1.TableHotKey(editor);
  }

  return HotKeyInstances;
}();

exports.HotKeyInstances = HotKeyInstances;
exports["default"] = {
  p: {
    func: menu_list_1["default"].head.prototype.command,
    args: ['<p>'],
    cls: menu_list_1["default"].head
  },
  h1: {
    func: menu_list_1["default"].head.prototype.command,
    args: ['<h1>'],
  ...
  bold: {
    func: menu_list_1["default"].bold.prototype.clickHandler,
    cls: menu_list_1["default"].bold
  },
  ul: {
    func: menu_list_1["default"].list.prototype.command,
    args: ['insertUnorderedList'],
    cls: menu_list_1["default"].list
  },
  li: {
    func: menu_list_1["default"].list.prototype.command,
  ...
  table: {
    func: menu_list_1["default"].table.prototype.clickHandler,
    cls: menu_list_1["default"].table
  },
  quote: {
    func: menu_list_1["default"].quote.prototype.clickHandler,
    cls: menu_list_1["default"].quote
  },
  code: {
    func: menu_list_1["default"].code.prototype.clickHandler,
    cls: menu_list_1["default"].code
  },
  italic: {
    func: menu_list_1["default"].italic.prototype.clickHandler,
    cls: menu_list_1["default"].italic
  },
  underline: {
    func: menu_list_1["default"].underline.prototype.clickHandler,
    cls: menu_list_1["default"].underline
  },
  delline: {
    func: menu_list_1["default"].strikeThrough.prototype.clickHandler,
    cls: menu_list_1["default"].strikeThrough
  },
  link: {
    func: menu_list_1["default"].link.prototype.clickHandler,
    cls: menu_list_1["default"].link
  },
  highlight: {
    func: menu_list_1["default"].backColor.prototype.command,
    cls: menu_list_1["default"].backColor,
    args: ['#ffff00']
  }
};
